...
class DeepHE3Kernel:
    ...
    def save_script(self):
        ...
        # move to different file folder, by Chen Qian
        shutil.copytree(os.path.join(src, 'maceh'), os.path.join(dst, 'maceh_1'))
        # shutil.copytree(os.path.join(src, 'configs'), os.path.join(config.save_dir, 'configs'))
